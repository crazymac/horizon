...
class DatabasesBackupsTests(test.TestCase):
    ...
    def test_index(self):
        ...
        self.assertNotEqual(self.database_backups.list(), None)
    ...
    def test_launch_backup(self):
        api.trove.instance_list(IsA(http.HttpRequest), limit=IsA(int)) \
            .AndReturn([])
        ...
        self.assertTemplateUsed(
            res, 'project/database_backups/backup.html',
            msg_prefix='http 200')
    ...
    def test_detail_backup(self):
        ...
        self.assertNotEqual(self.database_backups.first(), None)